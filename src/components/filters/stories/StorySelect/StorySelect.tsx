...
import { isCampaign, isChallenge, isSideContent } from '@/shared/store/features/stories/criteria';
...
export const StorySelect = ({ stories, clear = false, className }: StorySelectProps) => {
