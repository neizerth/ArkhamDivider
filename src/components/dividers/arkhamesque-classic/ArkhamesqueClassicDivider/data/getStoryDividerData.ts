import { getArkhamesqueClassicStory } from "@/shared/lib/store/features/dividers/arkhamesque/criteria";
...
export const getStoryDividerData = ({
	...
	const id =
		divider.scenario?.id || divider.encounterSet?.code || divider.campaign?.id;
