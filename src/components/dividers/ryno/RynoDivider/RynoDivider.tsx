...
export const RynoDivider = (props: DividerProps) => {
  ...
  const isGenericFaction = props.faction && !['neutral', 'multiclass'].includes(props.faction);
    ...
    <div className={containerClassName}>
      <div className={S.assetsContainer}>
        ...
        <div className={S.assets}>
          ...
          {hasFaction && isGenericFaction && <img className={S.factionIcon} src={factionImage} alt={props.faction} />}
      ...
      <DividerContent>
        {story && <div className={S.storyTitle}>
          <DividerText
        ...
        {showCorner && <div className={S.icon} onClick={selectIcon}>
          {icon && <CircleIcon
              icon={icon}
        ...
        {props.xpCost && (<div className={S.xp}>
