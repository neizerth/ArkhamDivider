...
export const VintageDivider = (props: VintageDividerProps) => {
  ...
  const moveRight = () => dispatch(moveTab(id, getNextTabPosition(tabPosition)));
  ...
  return (
    ...
    >
      <DividerContent className={S.content}>
        ...
        <div className={classNames(S.tab, S[`tab_${tabPosition}`])}>
          <NotExportable>
            ...
            {tabPosition !== 'right' && !backId && (
              <div className={classNames(S.moveTab, S.moveTab_right)} onClick={moveRight}>
                <Icon icon='action' />
              </div>
            )}
          </NotExportable>
          ...
          <div className={classNames(S.icon, xpCost && xpCost?.level > 0 && S.icon_xp)}>
            {icon && (
        ...
        {cornerRadius && (
          <NotExportable>
            <CornerRadius className={S.cornerRadius} $tabPosition={tabPosition} />
          </NotExportable>
        )}
      </DividerContent>
    </div>
