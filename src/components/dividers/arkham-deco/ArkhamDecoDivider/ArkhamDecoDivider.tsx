...
export const ArkhamDecoDivider = ({ ...props }: DividerProps) => {
  ...
  const { color, customParams, orientation } = useAppSelector(selectLayout);
        ...
        <div className={S.wrapper}>
            ...
            <div className={S.specialIcon}>
              ...
              {!specialIcon && xpCost && (
                <div className={S.xpCost}>
                  {xpCost.max && getXPDisplayValue(xpCost.level, xpCost.max, '-')}
          ...
          {size && (
            <div className={S.size}>
              ...
              <div className={S.sizeNumber}>{size}</div>
            </div>
          )}
          <div className={S.content}>
            ...
            {!lineIcon && (!isTab || isVertical) && (
              <img src={topLine} className={classNames(S.topLine, S[`topLine_${type}`])} alt='' />
            )}
            <div className={S.preview}></div>

            <img
              src={isTab ? tabTopCorner : topLeftCorner}
              className={classNames(S.topLeftCorner)}
              alt=''
            />
            <img
              src={topRightCornerImage}
              className={classNames(S.topRightCorner, isScenario && S.topRightCorner_scenario)}
              alt=''
            />

            <img
              src={centerBorder}
              className={classNames(S.centerBorder, S.centerBorder_left)}
              alt=''
            />
            <img
              src={centerBorder}
              className={classNames(S.centerBorder, S.centerBorder_right)}
              alt=''
            />
            ...
            <div className={classNames(S.bottomCorner, S.bottomCorner_left)}>
              <img src={bottomTentacle} className={S.bottomTentacle} alt='' />
              <img src={bottomCorner} className={S.bottomCornerImage} alt='' />
            </div>
            <div className={classNames(S.bottomCorner, S.bottomCorner_right)}>
              <img src={bottomTentacle} className={S.bottomTentacle} alt='' />
              <img src={bottomCorner} className={S.bottomCornerImage} alt='' />
            </div>
          </div>
