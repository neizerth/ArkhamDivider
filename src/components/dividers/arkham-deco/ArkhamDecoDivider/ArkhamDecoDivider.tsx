				...
				<div className={S.wrapper}>
					...
					<div
						className={classNames(
							...
							xpCost && [
								specialIcon
									? S.specialCorner_withXPIcon
									: S.specialCorner_noXPIcon,
							],
					...
					<div className={S.content}>
						<img
							src={scratches}
							alt=""
							className={classNames(S.scratches, S.scratches_1)}
						/>

						<img
							src={scratches}
							alt=""
							className={classNames(S.scratches, S.scratches_2)}
						/>
						...
						{!lineIcon && (!isTab || isVertical) && (
							<img
								src={topLine}
								className={classNames(S.topLine, S[`topLine_${type}`])}
								alt=""
							/>
						)}
