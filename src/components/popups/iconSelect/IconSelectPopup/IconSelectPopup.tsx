...
import { selectIcons, selectPopupIcon, setPopupIcon } from '@/shared/store/features/icons/icons';
...
export const IconSelectPopup = ({ show, className, contentClassName }: IconSelectPopupProps) => {
      ...
      <Col>
        <div className={S.row}>
          ...
          <Col className={S.sidebar}>
            <IconSelectPreview defaultIcon={selectedIcon} onChange={selectIcon} />
            <div className={S.nav}>
              <IconSelectNav
