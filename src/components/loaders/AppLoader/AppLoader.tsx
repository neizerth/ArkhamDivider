...
import { selectExport, selectLoading, selectLoadingStatus } from '@/shared/store/features/app/app';
        ...
        <div className={S.loader}>
          ...
          {loadingStatus && (
            <div className={S.status}>
              ...
              {loadingStatus.text && <div className={S.statusText}>{loadingStatus.text}</div>}
            </div>
          )}
        </div>
      )}
