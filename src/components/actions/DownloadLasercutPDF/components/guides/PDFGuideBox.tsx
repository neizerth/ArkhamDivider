...
export const PDFGuideBox = (props: {
	...
	const left =
		(pageSize.width - contentWidth) / 2 + bleedSize + relativeLeft - bleedGap;
	const top =
		(pageSize.height - contentHeight) / 2 + bleedSize + relativeTop - bleedGap;
	...
	const Component =
		categoryId in COMPONENT_MAP ? COMPONENT_MAP[categoryId] : PDFDividerGuides;
