...
import { ILayout, ILayoutCriteria, LayoutOrientation, LayoutType } from '@/shared/types/layouts';
...
export const getLayouts = ({ criteria, source = layouts }: GetLayoutsOptions) => {
