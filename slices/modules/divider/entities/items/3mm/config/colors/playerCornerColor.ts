...
const factionPlayerCornerColor: Record<string, RGBAColorObject> = {
...
const customPlayerCornerColor: Record<string, RGBAColorObject> = {
...
export const playerCornerColor: Record<string, RGBAColorObject> = {
