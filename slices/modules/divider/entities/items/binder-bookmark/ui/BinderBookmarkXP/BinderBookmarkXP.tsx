...
type BinderBookmarkXPProps = BoxProps & {
	xpCost: XPCost;
};
...
const gapX = 3.9; // horizontal distance between circle centers (~1.5–2 diameters)
const gapY = 1.3; // vertical step between arc levels (outer higher, center lower)
...
export function BinderBookmarkXP({ xpCost, ...props }: BinderBookmarkXPProps) {
